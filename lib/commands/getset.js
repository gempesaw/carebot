...
// (event: FlowdockEvent) -> Either[String, undefined]
...
set.description = '`.set userKey userValue` - create a user-defined key-value pair for subsequent retrieval. The previous incantation would mean that `.userKey` would make flowbot say `userValue`. Key names can only be letters or numbers.';
