...
queue.description = 'Do a build update & service restart on KMS only; accepts one argument: the name of the context. Currently, the only valid context is `articles-microsite`.';
...
setupBcsdConfig();
export default { queue, deploy, cancel };
